    ...
    <form action="${pageContext.request.servletPath}/lookup.do" method="POST">
        ...
        <div class="form-inline">
            ...
            <div class="input-group col-4 mb-3 mr-3">
                ...
                <input type="text" class="form-control" id="inputDateTimeRange" name="inputDateTimeRange" value=""
            ...
            <div class="input-group col-3  mb-3 mr-3">
                ...
                <input type="text" class="form-control" name="inputStartPrice" value="" aria-describedby="basic-addon5">
            ...
            <div class="input-group mb-3 mr-3">
                <div class="input-group-prepend">
                    <span class="input-group-text" id="basic-addon8">시설명</label>
                </div>
